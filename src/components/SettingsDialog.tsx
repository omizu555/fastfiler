...
import { everythingPing, pluginsDirPath, revealInExplorer, listPluginsWithStatus, importPluginZip, deletePlugin } from "../fs";
import { defaultHotkeys, eventToCombo, hotkeyLabels } from "../hotkeys";
import { setPluginEnabled, isPluginEnabled } from "../store";
import type { HotkeyAction, LinkChannel, PluginStatus } from "../types";
